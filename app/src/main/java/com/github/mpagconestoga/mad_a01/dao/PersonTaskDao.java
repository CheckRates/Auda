...
public interface PersonTaskDao {
    ...
    @Query("SELECT Id, CatId, Name, Category, StartTime, EndTime, Lattitude, Longitude FROM Task INNER JOIN Person_Task ON Task.Id = Person_Task.TaskId WHERE Person_Task.PersonId = :personId")
