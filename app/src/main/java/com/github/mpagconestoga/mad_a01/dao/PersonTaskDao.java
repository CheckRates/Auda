...
public interface PersonTaskDao {
    ...
    @Query("SELECT _id, CatId, Name, Category, StartTime, EndTime, Lattitude, Longitude FROM Task INNER JOIN Person_Task ON Task._id = Person_Task.TaskId WHERE Person_Task.PersonId = :personId")
